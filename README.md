<img src="https://github.com/user-attachments/assets/ae8b978d-1c85-414c-927a-914dee28092e" width="250px"/>
...
cc2 is an easy to use video encoder for Windows and macOS. Let's say you need your ```.mp4``` video as a ```.webm``` and ```.ogv```? In a small file size, without quality loss? Just drag and drop your video into your predefined folder and see magic happens.

Update v1.1.0 :zap:
-----------------------------
- [x] Container format support: **mov**, **mkv**
- [x] Mute audio stream
