...
class Controller:
    ...
    # verify_arguments_compression return only valid arguments according to the Helper.valid_arguments_compression
    ...
    # verify_arguments_type return only valid arguments according to the Helper.valid_arguments_type 

    def verify_arguments_type(self,arguments,cropped_file_extension):
        valid_arguments = []
        try:
            for param in arguments:
